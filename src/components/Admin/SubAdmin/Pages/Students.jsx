...
import { students as initialStudents, hasPermission } from '../data/subAdminData.js'
    ...
    <div className="subadmin-page">
      ...
      <div className="students-toolbar">
        ...
        {hasPermission('STUDENT_EXPORT') && (
          <button type="button" className="subadmin-toolbar-btn" onClick={() => setDownloadNote('export')}>
            <FontAwesomeIcon icon={faFileExport} /> Export
          </button>
        )}

        {hasPermission('STUDENT', 'WRITE') && (
          <button type="button" className="subadmin-toolbar-btn subadmin-toolbar-btn-primary" onClick={() => navigate('/admin/subadmin/students/add')}>
        ...
        {pageItems.map((s) => (
          <div key={s.id} className="students-table-row">
            ...
            <span className="students-row-actions">
              <FontAwesomeIcon icon={faEye} className="assignment-action-icon" title="View" onClick={() => navigate(`/admin/subadmin/students/${s.id}`)} />
              ...
              {hasPermission('STUDENT', 'UPDATE') && (
                <FontAwesomeIcon icon={faPenToSquare} className="assignment-action-icon" title="Edit" onClick={() => navigate(`/admin/subadmin/students/${s.id}`, { state: { openEdit: true } })} />
              )}
