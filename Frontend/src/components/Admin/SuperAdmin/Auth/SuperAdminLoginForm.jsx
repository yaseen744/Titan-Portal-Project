...
function SuperAdminLoginForm({ onSubmit, onForgotPassword }) {
  ...
  return (
    <form className="auth-form" onSubmit={handleSubmit} noValidate>
      ...
      <p className="auth-form-subtext">
        Kindly provide the email and password assigned to your admin account.
      </p>

      <div className="auth-input-group">
        <label className="auth-input-label" htmlFor="superadmin-email">
      ...
      <div className="auth-input-group">
        <label className="auth-input-label" htmlFor="superadmin-password">
