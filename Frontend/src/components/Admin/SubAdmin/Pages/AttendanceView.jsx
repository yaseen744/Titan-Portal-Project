...
import { findStudentByRoll, getStudentAttendanceCalendar } from '../data/subAdminData.js'
...
function AttendanceView() {
  ...
  return (
    <div className="subadmin-page">
      <SubAdminTopbar breadcrumb={['Home', 'Attendance', 'View Attendance']} />
      ...
      {student && calendar && (
        <>
          ...
          <div className="calendar-box">
            <h4 className="subadmin-chart-title" style={{ marginBottom: 14 }}>June 2026</h4>
