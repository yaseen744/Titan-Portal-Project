  ...
  return (
    <div className="subadmin-page">
      ...
      <div className="students-table-box">
        ...
        {pageItems.map((s) => (
          <div key={s._id} className="students-table-row">
            ...
            <span className="students-row-actions">
              <FontAwesomeIcon icon={faEye} className="assignment-action-icon" title="View" onClick={() => navigate(`/admin/subadmin/students/${s._id}`)} />
              ...
              {hasPermission('STUDENT', 'UPDATE') && (
                <FontAwesomeIcon icon={faPenToSquare} className="assignment-action-icon" title="Edit" onClick={() => navigate(`/admin/subadmin/students/${s._id}`, { state: { openEdit: true } })} />
              )}
      ...
      {downloadListPopup && (
        <DownloadProgressPopup
          ...
          run={() => api.download('/pdf/students', 'students-list.pdf')}
